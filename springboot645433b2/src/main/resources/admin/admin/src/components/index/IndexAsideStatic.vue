...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
				...
				padding: 10px 0;
				margin: 0px auto;
				background: url(http://codegen.caihongy.cn/20230929/d3ba9dbd84f644a093bdabc08e5d1b12.png) no-repeat center top / 100% auto,url(http://codegen.caihongy.cn/20230929/f33e3bd8b6704ea8b156c1ed91e877f8.png) no-repeat center bottom / 100% auto,#fff;
				width: 90%;
				font-size: inherit;
			}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
				...
				border-radius: 0px !important;
				background: url(http://codegen.caihongy.cn/20230929/c841e02f2ecd4e438724ccc87f94b9b3.png) no-repeat 15px center / 8px !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
				...
				line-height: 40px;
				border-radius: 0px;
				background: url(http://codegen.caihongy.cn/20230929/c841e02f2ecd4e438724ccc87f94b9b3.png) no-repeat 15px center / 8px;
				width: auto;
